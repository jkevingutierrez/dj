  ...
  render() {
    ...
    return (
      <ListItem>
        <ListItemText
          primary = {
            `Solicitud de ${type} en ${location.charAt(0).toUpperCase() + location.slice(1).toLowerCase()} para ${date}`
          }
        />
      <ListItemSecondaryAction>
        ...
        <Button variant="contained" color="secondary" className={classes.button} onClick={handleReject}>
          Rechazar
        </Button>
      </ListItemSecondaryAction>
    </ListItem>
